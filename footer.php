<!-- call block -->
<section class="call-to-action-6">
    <div class="container py-md-5 py-sm-4 py-5">
        <div class="d-lg-flex align-items-center justify-content-between">
            <div class="left-content-call">
                <h3 class="title-big">Call To Your Donate</h3>
            ...
            <div class="right-content-call mt-lg-0 mt-4">
                <ul class="buttons">
                    <li class="phone-sec me-lg-4"><i class="fas fa-phone-volume"></i>
                        <a class="call-style-w3 " href="tel:+8801610230408">+8801778402398</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="footer-29 pt-5 pb-4">
        <div class="container pt-md-4">
            ...
            <p class="copy-footer-29 text-center pt-lg-2 mt-5 pb-2">© 2022 Desh Charity. All rights reserved.
                Design
                by <a class=" " href="index.html" target="_blank">Desh Charity</a></p>
            <!-- //copyright -->
        </div>
    </div>
</footer>
